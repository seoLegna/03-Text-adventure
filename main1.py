...
def the_galadrielic_tree():
    ...
    "were not it's roots but several heaps of creatures.... humans which you somehow knew, now fallen near a broken branch." 
    ...
    print("Do you want to pick up the branch?"
    ...
    time.sleep(2)
    print("A. Go near the tree and see if someone is alive"
    ...
    if choice == answer_a and fallen_branch == 1:
        print("You go near the tree to check on your fallen comrades"
        ...
        print("You rest a bit more and then die."
        "The end."
        ""
        "You are dead"
        ""
